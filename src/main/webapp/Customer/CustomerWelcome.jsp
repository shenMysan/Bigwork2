...
<div id="container">
    ...
    <div id="left">
        ...
        <ul id="tabs_nav" >
            ...
            <li  ><a href="1.html?id=<%=id%>" target="mainFrame" >开始打车</a></li>
            <li  ><a href="4.html?id=<%=id%>" target="mainFrame">支付订单</a></li>
            <li  ><a href="3.html?id=<%=id%>" target="mainFrame">查看订单</a></li>
            <li  ><a href="5.html?id=<%=id%>" target="mainFrame">个人信息</a></li>
