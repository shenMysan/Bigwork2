...
<div id="container">
    ...
    <div id="left">
        ...
        <ul id="tabs_nav" >
            ...
            <li  ><a href="1.html?id=<%=id%>"   target="mainFrame" >订单查看</a></li>
            <li  list-style: none;><a href="4.html?id=<%=id%>"   target="mainFrame">司机信息查看</a></li>
            <li  list-style: none;><a href="5.html?id=<%=id%>"   target="mainFrame">用户信息查看</a></li>
